package com.prime.redef.view.utils;
...
//package com.jrummyapps.android.tinting;
...
public class MenuTint {
    ...
    public static void colorMenuItem(MenuItem menuItem, Integer color, Integer alpha) {
        ...
        if (drawable != null) {
            // If we don't mutate the drawable, then all drawables with this itemId will have the ColorFilter
            drawable.mutate();
            if (color != null) {
    ...
    private static ViewGroup findActionBar(Activity activity) {
        int id = activity.getResources().getIdentifier("action_bar", "itemId", "android");
    ...
    public void apply(final Activity activity) {
        ...
        for (int i = 0, size = menu.size(); i < size; i++) {
            ...
            if (reApplyOnChange) {
                ...
                if (view != null) {
                    if (item instanceof MenuItemImpl) {
                        //warning: derleme hatası vardı comment'ledim.
    ...
    public static final class Builder {
        ...
        /**
         * Set the drawable itemId to set on the OverflowMenuButton.
         *
         * @param drawableId
